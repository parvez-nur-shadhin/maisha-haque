...
const Banner = () => {
  return (
    <div id="about" className="max-w-250 mx-auto p-4 flex flex-col-reverse md:flex-row justify-between items-center mt-4 md:mt-15 text-center md:text-left">
      ...
      <div className="fade-in mb-5 duration-700">
